    <form action="" method="post">
        ...
        <input type="number" name="rot" min="0" max="25" placeholder="rotacion">
        <input type="submit" value="cifrar" name="cifrar">
...
if(isset($_POST["cifrar"])){
    ...
    $rot = $_POST["rot"];
    $url = "http://localhost//Proyecto5/encrypt&decrypt/servCesarENC.php?msj=$msj&rot=$rot";
